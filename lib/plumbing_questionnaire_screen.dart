...
class PlumbingQuestionnaireScreen extends StatefulWidget {
  const PlumbingQuestionnaireScreen({Key? key}) : super(key: key);

  @override
  _PlumbingQuestionnaireScreenState createState() => _PlumbingQuestionnaireScreenState();
}

class _PlumbingQuestionnaireScreenState extends State<PlumbingQuestionnaireScreen> {
  int currentStep = 1;
  ...
  final List<String> _waterSupplyOptions = [
    'Yes, water is off',
    'No, still running',
  ...
  Widget _buildLocationStep() {
    return _buildQuestionCard(
      question: 'Where is the plumbing problem located?',
      options: _locations,
  ...
  Widget _buildWaterSupplyStep() {
    return _buildQuestionCard(
      question: 'Have you turned off the water supply?',
      options: _waterSupplyOptions,
      selectedValue: waterSupplyStatus,
      onChanged: (value) {
        setState(() {
          waterSupplyStatus = value;
        });
      },
    );
  }
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Please describe the plumbing problem in detail',
                style: TextStyle(
                  fontSize: 16,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Include any sounds, visible damage, water pressure issues, how long it\'s been happening, etc.',
  ...
  Widget _buildBudgetStep() {
    return _buildQuestionCard(
      question: 'What\'s your budget range for this plumbing work?',
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 8),
              Text(
                'Photos help plumbers understand your needs better and provide more accurate quotes',
                style: TextStyle(
                  fontSize: 14,
                  color: Colors.grey[600],
                ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  'These details help us match you with the right plumber and ensure they come prepared with the right tools and knowledge.',
                  style: TextStyle(
                    fontSize: 12,
                    color: Color(0xFF2E86AB),
                  ),
  ...
  bool _canProceed() {
    switch (currentStep) {
      ...
      case 3:
        return waterSupplyStatus.isNotEmpty;
      case 4:
